...
class CreateOrder(pydantic.BaseModel):
    customer_id: int
    amount: float
    order_date: datetime.date


class UpdateDeleteOrder(pydantic.BaseModel):
    id: Optional[int] = None
...
class UpdateDeleteCustomer(pydantic.BaseModel):
    id: Optional[int] = None
    name: Optional[str] = None
...
class ValidationModels:
    ...
    update_delete_order = UpdateDeleteOrder
    create_customer = CreateCustomer
    update_delete_customer = UpdateDeleteCustomer
...
class ValidationMethods(str, enum.Enum):
    ...
    CREATE_ORDER = "validate_order_creation_data"
    UPDATE_DELETE_ORDER = "validate_update_delete_order_data"
    CREATE_CUSTOMER = "validate_customer_creation_data"
    UPDATE_DELETE_CUSTOMER = "validate_update_delete_customer_data"
...
class Validator:
    ...
    def validate_order_creation_data(self, **order_data: dict):
        return self._validate_data(validation_model=self.validation_models.create_order, data=order_data)

    def validate_customer_creation_data(self, **customer_data: dict):
        return self._validate_data(validation_model=self.validation_models.create_customer, data=customer_data)

    def validate_update_delete_customer_data(self, **customer_data: dict):
        return self._validate_data(validation_model=self.validation_models.update_delete_customer, data=customer_data)
